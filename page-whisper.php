...
<?php function threadedComments($comments, $options): void
{
    $commentClass = '';
        ...
        ?>>
            ...
            <?php } else { ?>
                <div class="comment-author comment-content">
                    <a <?php
                    if ($comments->parameter->allowComment || Widget::widget('Widget_User')->pass('editor', true)) {
                    ...
                    <p <?php if (!$this->user->hasLogin()): ?>class="textbutton" <?php endif; ?>>
                        <?php if (!$this->user->hasLogin()): ?>
                            ...
                            <input type="url" name="url" id="url" class="text"
                                   placeholder="https://<?php if ($this->options->commentsRequireURL): ?> *<?php endif; ?>"
